...
router.post(ROUTES.EVENTS.CREATE, authMiddleware, controller.createEvent.bind(controller));
router.get(`${ROUTES.EVENTS.DETAIL}/:id`, authMiddleware, controller.getEvent.bind(controller));
router.put(`${ROUTES.EVENTS.UPDATE}/:id`, authMiddleware, controller.updateEvent.bind(controller));
